...
public class ScreensharingCapturer extends BaseVideoCapturer implements  PixelCopy.OnPixelCopyFinishedListener{
    ...
    private Runnable newFrame = new Runnable() {
        ...
        public void run() {
            if (capturing) {
                ...
                PixelCopy.request((SurfaceView) contentView, bmp, ScreensharingCapturer.this, handlerPixelCopy);
